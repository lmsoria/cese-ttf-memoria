...
\begin{itemize}
	...
	\item Algunos aspectos previstos en la planificación original no se completaron en esta etapa y quedaron planteados como líneas de trabajo futuro. Asimismo, el desarrollo demandó un plazo de ejecución mayor al previsto originalmente. No obstante, estas cuestiones no invalidan el resultado principal alcanzado ni el cumplimiento de los objetivos técnicos centrales del trabajo.
\end{itemize}
...
\begin{itemize}
	\item Incorporar la exposición de las entradas y salidas MIDI a través del puerto USB, para habilitar el control bidireccional con la computadora.
	...
	\item Mejorar la experiencia de uso de la aplicación de escritorio e incorporar la posibilidad de actualizar el firmware desde esa interfaz.
