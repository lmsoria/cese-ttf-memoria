...
En la tabla \ref{tab:channel-messages} se listan todos los mensajes de canal definidos por el estándar, incluyendo la cantidad de bytes de datos que posee cada uno de ellos.
\begin{table}[h]
	\centering
