...
Se utilizó GoogleTest \cite{googletest} para implementar y correr los tests unitarios de los módulos desarrollados. Por otro lado, se utilizó Python 3.10 \cite{python} para automatizar las pruebas de latencia y procesar los resultados generados.
