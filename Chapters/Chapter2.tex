...
Dado que MIDI es un estándar basado en comunicación serie, para la etapa inicial del trabajo se han utilizado ocho conversores Serie-USB basados en el CH340G \cite{wch:ch340g}. En la figura \ref{fig:usb-serial} se observa una fotografía de un conversor de este tipo.
