...
Una vez modelado el panel frontal, se procedió con exportar un archivo \texttt{.dxf} del mismo, requerido por el fabricante para realizar el mecanizado. En la figura \ref{fig:gabinete} se observa una fotografía del gabinete ya ensamblado.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{./Figures/gabinete.jpg}
	\caption{Gabinete ensamblado.}
	\label{fig:gabinete}
\end{figure}
