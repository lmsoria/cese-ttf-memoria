...
\begin{itemize}
	...
	\item Pads para exponer una UART adicional, usada con fines de debbuging.
...
Dado que son gabinetes estandarizados, se contactó con un productor, y se coordino el mecanizado del frente de un gabinete de 100 mm de profundidad. Para ello se modeló el gabinete en Fusion 360, y se colocaron los modelos 3D de las placas exportados en KiCad. En la figura \ref{fig:render} se muestra un render con el despiece de las placas, el gabinete y el panel frontal.
