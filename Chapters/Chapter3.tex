...
%\end{figure}
%
%En caso de que haya un error en la deserialización del comando recibido, el servicio se encarga de enviar un pedido de retransmisión (\texttt{Retx}) como respuesta.
%
...
\footnotetext{Imagen extraída de: MIDI Manufacturers Association, \textit{MIDI 1.0 Detailed Specification}, documento 96-1-4, versión 4.2.1, 1996.}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{./Figures/circuit-input-stage.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\textwidth]{./Figures/circuit-output-stage.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{./Figures/circuit-user.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{./Figures/hw-blocks.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./Figures/circuit-out-connector.png}
...
Las placas de circuito impreso fueron diseñadas con la intención de ser alojadas en un gabinete tipo rack de 19 pulgadas, ya que están estandarizados para equipamiento electrónico e informático. Estos gabinetes se dimensionan mediante unidades de rack (1 U equivale a 1,75 pulgadas). Se estableció como requerimiento usar un gabinete de 1 RU.
