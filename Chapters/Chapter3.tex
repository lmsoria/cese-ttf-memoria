...
El contenido de cada mensaje es a su vez una estructura que contiene la información necesaria para procesar cada comando. Una vez decodificados, se envían eventos a la aplicación principal para hacer el procesamiento y generar la respuesta a enviar. En la figura \ref{fig:proto-sequence} se ilustra un diagrama de secuencia representando el intercambio de mensajes entre la aplicación y el firmware.
...
\begin{enumerate}
	...
	\item El área central donde se muestra el estado del preset, usando matrices de checkboxes para configurar las opciones de ruteo y filtrado de mensajes. En esta área también se pueden editar los nombres de las entradas, salidas y del preset.
\end{enumerate}
