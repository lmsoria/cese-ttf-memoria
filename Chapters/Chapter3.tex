...
Dado que son gabinetes estandarizados, se contactó a un proveedor para coordinar el mecanizado del frente de un gabinete de 100 mm de profundidad. Para ello se modeló el gabinete en Fusion 360, y se colocaron los modelos 3D de las placas exportados en KiCad. En la figura \ref{fig:render} se muestra un render con el despiece de las placas, el gabinete y el panel frontal.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{./Figures/render.png}
	\caption{Render del gabinete diseñado.}
	\label{fig:render}
\end{figure}

Una vez modelado el panel frontal, se exportó el archivo \texttt{.dxf} requerido por el fabricante para realizar el mecanizado. En la figura \ref{fig:gabinete} se observa una fotografía del equipo ensamblado en el gabinete, con la tapa superior removida para mayor visibilidad.
