...
\begin{itemize}
	\item \texttt{ButtonPressed}: se detectó una pulsación simple.
	\item \texttt{ButtonDoublePressed}: se detectó una pulsación doble dentro de una ventana temporal configurable.
	\item \texttt{ButtonLongPressed}: se detectó una pulsación prolongada, con duración superior al umbral configurado.
	\item \texttt{DialCW}: se detectó un giro en sentido horario.
	\item \texttt{DialCCW}: se detectó un giro en sentido antihorario.
\end{itemize}
