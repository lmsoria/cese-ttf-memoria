...
Con esta premisa se sientan las bases del protocolo de comunicación. En el apéndice \ref{anexo:comandos} se puede consultar la lista de mensajes desarrollados.
...
La placa central consiste de cinco bloques, que se ilustran en la figura \ref{fig:hw-blocks}.
...
\begin{itemize}
	...
	\item Test points para todas las señales.
	\item Pads para exponer una UART adicional, usada con fines de debugging.
	\item Pads a pines no utilizados del microcontrolador, para facilitar futuras ampliaciones del hardware.
\end{itemize}
...
Dado que son gabinetes estandarizados, se contactó con un productor, y se coordinó el mecanizado del frente de un gabinete de 100 mm de profundidad. Para ello se modeló el gabinete en Fusion 360, y se colocaron los modelos 3D de las placas exportados en KiCad. En la figura \ref{fig:render} se muestra un render con el despiece de las placas, el gabinete y el panel frontal.
