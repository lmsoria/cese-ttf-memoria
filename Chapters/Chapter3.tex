...
Además de lo mencionado explícitamente, durante la etapa de diseño se agregaron otros elementos que solo se mencionan:
\begin{itemize}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.6\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./Figures/mrc-main-board-bottom}
		\caption{Vista inferior.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./Figures/render.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./Figures/gabinete.jpg}
