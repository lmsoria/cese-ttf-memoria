...
Luego de presentar algunas alternativas comerciales, en la tabla \ref{tab:comparativa-modelos} se sintetizan las principales características de cada una de ellas, incluyendo el costo aproximado de los productos en dólares estadounidenses.
...
En síntesis, las alternativas revisadas tienden a ubicarse en dos extremos: por un lado, soluciones relativamente simples, orientadas a la distribución o combinación básica de señales sin capacidades de configuración; por otro lado, sistemas de alta complejidad que ofrecen un control exhaustivo del routeo y del filtrado. Permanece abierto, por lo tanto, un espacio intermedio para dispositivos que ofrezcan varias entradas y salidas físicas junto con funciones de routeo y filtrado configurables, pero con una interfaz de usuario más acotada y directa.
...
El objetivo general de este trabajo fue el desarrollo integral del prototipo de un router MIDI de cuatro entradas y ocho salidas, capaz de gestionar el flujo de mensajes entre ellas mediante funciones de routeo y filtrado configurables.

Para alcanzar este objetivo general se definieron los siguientes objetivos específicos:
\begin{itemize}
	\item Diseñar y ensamblar el circuito electrónico del equipo, incluyendo las etapas de interfaz MIDI, procesamiento y alimentación.
	\item Desarrollar el firmware embebido que implemente las funciones de recepción, procesamiento, routeo y filtrado de mensajes MIDI, así como el almacenamiento de configuraciones.
	\item Desarrollar una aplicación de escritorio que permita configurar el equipo, supervisar su estado de funcionamiento y gestionar las distintas configuraciones de routeo y filtrado.
	...
	\item Verificar el funcionamiento del sistema mediante ensayos representativos, incluyendo pruebas de comunicación, de estabilidad y de latencia.
\end{itemize}
