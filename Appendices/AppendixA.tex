...
\begin{table}[ht]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{ll}
			...
			\texttt{SetActivePreset}            & Establecer el preset \texttt{preset\_number} como activo.                                                                                                                                           \\
...
\begin{table}[ht]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{ll}
			...
			\texttt{SystemStateChunk}             & Envío del paquete \texttt{packet\_number} con un buffer \texttt{data}. \\
			\bottomrule
			\hline
		\end{tabular}%
	}
