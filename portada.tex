...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Desarrollo de un router MIDI configurable} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Leandro Martín Soria} \\[1cm]
        ...
        \textbf{Director:} Dr. Ing. Javier Schandy (FING - UdelaR)} \\[1cm]

        % Jurados
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Jurados:}} \\[0.5cm]
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Dr. Ing Román Comelli (UNR)} \\
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Ing. Santiago Hormazabal (UNR) (UNR)} \\
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Mg. Ing. Agustín Baffo (FIUBA)} \\[2cm]

        % Fecha y lugar
        {\fontfamily{phv}\itshape\fontsize{10pt}{12pt}\selectfont
        Ciudad de Rosario, abril de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
